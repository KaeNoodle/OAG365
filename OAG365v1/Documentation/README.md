...
.\OAG-MainRunFile.ps1 -report ORG -output C:\Audit\ClientName\2026

# skip the export that needs Global Administrator
.\OAG-MainRunFile.ps1 -report ORG -skipOnPremSync

# unattended, no confirmation pauses
.\OAG-MainRunFile.ps1 -nonInteractive
```
...
# secret
.\OAG-MainRunFile.ps1 -appClientId "d359..." -appTenantId "a1b2..." -appSecret "a1bC2d~..."
```
...
```powershell
.\Tools\Verify-Export.ps1 -runFolder C:\Audit\M365\20260824_142530
```
