...
The module is covered by a single file catalog, `OagExportM365.cat`, rather than by an
...
```powershell
Set-AuthenticodeSignature -FilePath .\OagExportM365.cat `
...
```powershell
Test-FileCatalog -CatalogFilePath .\OagExportM365.cat -Path . -Detailed
Get-AuthenticodeSignature -FilePath .\OagExportM365.cat | Format-List
```
...
> Evidence was collected using OagExportM365 v4.0.0. The module's file catalog and Authenticode
